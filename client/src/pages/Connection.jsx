 ...
 const [currentTab,setCurrentTab]  = useState('Followers');
    ...
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">Manage your network and discover new network </p>
        </div>
        {/* counts */}
                              ...
                              rounded-md p-1 bg-white shadow-sm">
  {
      dataArray.map(
          (tab) => (
            <button
              onClick={()=> setCurrentTab(tab.label)} key={tab.label}
      ...
      <div className="flex flex-wrap gap-6 mt-6">
        {
          dataArray.find( (item) => item.label === currentTab).value.map(
            (user) => (
              <div key={user._id} >
