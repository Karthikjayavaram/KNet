...
const Feed = () => {
  ...
  return !loading ? (
    <div className='h-full overflow-y-scroll no-scrollbar py-10 x1:pr-5 flex
        items-start justify-center xl:gap-8'>
          ...
          <div className="max-xl:hidden sticky top-0">
              ...
              inline-flex flex-col gap-2 shadow ">
                ...
                <p className="text-slate-400">Superchange your marketing with a powerful 
                  easy to use built for results 
                </p>
              </div>
              <RecentMessages/>
          </div>
